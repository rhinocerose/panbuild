...
\usepackage{tocloft}
    ...
    \renewcommand{\cftsecpresnum}{\color{$toctitlecolor$}}
    \renewcommand{\cftsubsecpresnum}{\color{$toctitlecolor$}}
    \renewcommand{\cftsubsubsecpresnum}{\color{$toctitlecolor$}}
	\renewcommand{\cfttoctitlefont}{\fontsize{26}{22}\sffamily\bfseries\color{$toctitlecolor$}}
