...
\usepackage{fancyhdr}
	...
	\fi
		\fancyhead[L]{\sffamily\fontsize{10pt}{11pt}\selectfont \color{$if(grayscale)$$othercolorbw$$else$$othercolor$$endif$}\textsf{\textbf{$title$  \color{black}$subtitle$}} }
...
\title{
    ...
    \vspace{-6.0em}
    \begin{flushleft}
        \Huge \textbf{\textsf{\color{$kpmcolor$}$org_name$} }\\ % Assignment title
        \vspace{-0.17em}
